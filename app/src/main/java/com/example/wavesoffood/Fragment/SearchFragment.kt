...
class SearchFragment : Fragment() {
    ...
    private val originalMenuItems = mutableListOf<com.example.wavesoffood.model.MenuItem>()
    ...
    private fun setAdapter(filteredMenuItem: List<com.example.wavesoffood.model.MenuItem>) {
